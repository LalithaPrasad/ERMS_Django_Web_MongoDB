...
from app_django.employee_model import Employee
...
def login(request):
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            admin=Admin.objects.using('admindata').filter(username=un).first()
